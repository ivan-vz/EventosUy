...
namespace EventosUy.Application.Interfaces
{
    ...
    {
        public Task<Result<Guid>> CreateAsync(string name, SponsorshipTier tier, decimal amount, int free, string code, DateOnly expiration, Guid editionId, Guid institutionId, Guid registerTypeId);
