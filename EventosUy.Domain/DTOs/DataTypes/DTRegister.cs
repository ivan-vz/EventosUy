...
namespace EventosUy.Domain.DTOs.DataTypes
{
    public class DTRegister
    {
        ...
        public DTRegister(string registerType, string edition, DateTimeOffset created, float total, string sponsor_code, Participation participation, RegisterState state) 
        {
