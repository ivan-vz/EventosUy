...
{
    public class UpdateInstitutionValidator
    {
        private readonly InstitutionUpdateValidator _validator;
        public UpdateInstitutionValidator() 
        {
            _validator = new InstitutionUpdateValidator();
        }
        ...
        {
            // Arrange
            var model = new DTUpdateInstitution(
                id: Guid.Empty,
                nickname: "nickname",
