...
{
    public class CreateEditionValidator
    {
        private readonly EditionInsertValidator _validator;

        public CreateEditionValidator() 
        {
            _validator = new EditionInsertValidator();
        }
        ...
        [Fact]
        public void Should_Have_Error_When_Event_Is_Invalid()
        {
            // Arrange
            var model = new DTInsertEdition(
                    name: "name",
            ...
            // Assert
            result.ShouldHaveValidationErrorFor(x => x.Event);
        }
